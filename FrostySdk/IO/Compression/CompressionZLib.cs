...
public partial class CompressionZLib : ICompressionFormat
{
    ...
    [LibraryImport(NativeLibName)] internal static partial int uncompress(IntPtr dst, ulong dstCapacity, IntPtr source, ulong compressedSize);
    ...
    {
        int err = uncompress((IntPtr)outData.Ptr, (ulong)outData.Size, (IntPtr)inData.Ptr, (ulong)inData.Size);
        Error(err);
    }
