...
namespace LevelEditorPlugin.Entities
{
	...
	public class LensFlareReferenceObject : SpatialReferenceObject, IEntityData<FrostySdk.Ebx.LensFlareReferenceObjectData>
	{
		...
		public new Assets.LensFlareBlueprint Blueprint => blueprint as Assets.LensFlareBlueprint;
		public new LensFlareEntity RootEntity => entities[0] as LensFlareEntity;
